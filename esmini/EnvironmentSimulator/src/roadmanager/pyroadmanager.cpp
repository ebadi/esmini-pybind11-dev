...
void bind_unknown_unknown_4(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // roadmanager::Road file: line:976
		...
		cl.def("GetDrivingLaneSideByIdx", (class roadmanager::Lane * (roadmanager::Road::*)(double, int, int)) &roadmanager::Road::GetDrivingLaneSideByIdx, "C++: roadmanager::Road::GetDrivingLaneSideByIdx(double, int, int) --> class roadmanager::Lane *", pybind11::return_value_policy::automatic, pybind11::arg("s"), pybind11::arg("side"), pybind11::arg("idx"));
